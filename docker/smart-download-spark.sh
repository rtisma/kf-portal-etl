...
SPARK_DOWNLOAD_PATH=https://archive.apache.org/dist/spark/spark-${SPARK_VERSION}/${SPARK_FILENAME}
SPARK_HASH_PATH=https://archive.apache.org/dist/spark/spark-${SPARK_VERSION}/${SPARK_FILENAME}.${HASH_TYPE}
